<template>
  <div class="box box__opened">
    <ul class="box__nav box__menu">
      <li class="box__menu--main">
        <div>
          ...
          <NuxtLink class="box__menu--link uppercase" to="/game/dbfz"
            >DBFZ</NuxtLink
          >
          <NuxtLink class="box__menu--link uppercase" to="/game/ranking"
            >Ranking</NuxtLink
          >
        </div>
